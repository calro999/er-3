      ...
      <body className="min-h-full flex flex-col bg-[#f1f5f9] text-slate-900 selection:bg-rose-500 selection:text-white font-sans antialiased">
        ...
        <div className="flex-grow w-full relative flex justify-center items-start">
          ...
          <aside className="hidden xl:flex flex-col fixed left-4 top-24 w-[270px] z-30 space-y-6 items-center">
            <AmateurBanner affiliateId="onchan555-008" bannerId="1082_300_250" />
            <AmateurBanner affiliateId="onchan555-008" bannerId="377_300_250" />
            <AmateurBanner affiliateId="onchan555-008" bannerId="1980_300_250" />
          </aside>
          ...
          <aside className="hidden xl:flex flex-col fixed right-4 xl:right-[calc((100vw-1152px)/4-135px)] top-24 w-[270px] z-30 space-y-6 items-center">
            <AmateurBanner affiliateId="onchan555-008" bannerId="75_300_250" />
            <AmateurBanner affiliateId="onchan555-008" bannerId="68_300_250" />
            <AmateurBanner affiliateId="onchan555-008" bannerId="1506_300_250" />
          </aside>
        </div>
        ...
        <script async src="https://adm.shinobi.jp/st/auto.js" data-admax-id="fd7f787129eedcb646eaa9fdc1978e9a" suppressHydrationWarning />
      </body>
    </html>
  );
}
