    ...
    <>
      ...
      <div className="space-y-8 max-w-5xl mx-auto">
        ...
        <section className="text-center py-6">
          <a href={`https://al.fanza.co.jp/?lurl=https%3A%2F%2Fwww.dmm.co.jp%2Fsearch%2F-%2F%3Fsearchstr%3D${encodeURIComponent(genreName)}%2F&af_id=onchan555-003`} target="_blank" rel="noopener noreferrer"
